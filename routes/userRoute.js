...
router.put('/updateUser', authController.authenticateToken, userController.updateUser);

// API xóa người dùng - yêu cầu xác thực
router.delete('/deleteUser', authController.authenticateToken, userController.deleteUser);
